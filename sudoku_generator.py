"""
This class performs the background mathematical computations to generate a valid Sudoku game.
...
class SudokuGenerator:
    """
    Creates a 2D sudoku board. Initializes class variables:
    ...
    '''
    Displays the board to the console. This is not strictly required, but it may be useful for debugging purposes.
    Parameters:
        None 
    Return:
        None
    ...
    def valid_in_row(self, row, num):
        ...
        for row_index in range(len(self.board)):
            if row_index < self.row_length:
                if self.board[row_number][row_index] == int(num):
                    return False
        return True
    ...
    Parameters:
        row_start and col_start are the  indices of the top left cell of the 3x3 box to check
    ...
    def is_valid(self, row, col, num):
        ...
        c = self.valid_in_box(3 * (row // 3), 3 * (col // 3), num)
        if a and b and c:
            return True
        else:
            return False
    ...
    Should be called after the entire solution has been constructed (i.e. after calling fill_values).
    Parameters:
        None 
    Return:
        None
